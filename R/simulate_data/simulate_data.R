simulate_data <- function(simulationConfig, samples, model, indPath, isOracle = FALSE, 
                                   typeOfSimulator="random", returnData=TRUE, verbose=0) {
  ...
  # Independence test are already done, there is no need to simulate_data anything.
  if (!is.null(indPath)) {
